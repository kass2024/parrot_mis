...
<html>
<head>
<title>Attendance Report Dashboard - Parrot Canada Visa Consultant</title>
<meta charset="UTF-8">
...
$("#pdfBtn").click(function (e) {
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Parrot Canada Visa Consultant - Attendance Report</title>
            <style>
                body { 
        ...
        <body>
            ...
            <div class="footer">
                Generated on ${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()} | Parrot Canada Visa Consultant © ${new Date().getFullYear()}
            </div>
