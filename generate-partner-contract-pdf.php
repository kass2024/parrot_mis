...
class EnglishPDFGenerator extends PDFGeneratorBase {
    ...
    protected function getContractContent(): string {
        ...
        <ul>
            ...
            <li>Parrot Canada Visa Consultant Co. Ltd commits to pay application service fees to Company Name: ' . $this->esc($this->contract['company_name']) . ' upon issuance of official admission letter.</li>
