...
<p>The purpose of this Agreement is to establish the terms and conditions under which PARROT CANADA VISA CONSULTANT CO. LTD. shall provide professional recruitment, training placement, and relocation support to enable the Client to undertake professional training together with Russian language study, and to be placed in a work-training position in the Russian Federation.</p>
...
<p>PARROT CANADA VISA CONSULTANT CO. LTD. is committed to providing professional recruitment, training-placement, and relocation support services throughout the Client's participation in the Employment Opportunities program.</p>
<?php if ($programFee !== ''): ?>
