...
/**
 * job-application.php
 * Job Application Form for Parrot Canada Visa Consultant
...
<head>
    ...
    <title>Job Application | Parrot Canada Visa Consultant</title>
...
<body>
    ...
    <div class="application-container" id="applicationContainer">
        ...
        <div class="header-section">
            ...
            <p class="subtitle">Apply for international jobs with guidance from <strong>Parrot Canada Visa Consultant</strong>.</p>
            <div class="mt-3">
