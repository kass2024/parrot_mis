...
<head>
    ...
    <title>Visa Application — Parrot Canada Visa Consultant</title>
                ...
                <div class="visa-field-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="company" required>
                            ...
                            <option value="PARROT CANADA VISA CONSULTANT LTD" <?php echo selected('company', 'PARROT CANADA VISA CONSULTANT LTD'); ?>>PARROT CANADA VISA CONSULTANT LTD</option>
                        </select>
                    </div>
                </div>
