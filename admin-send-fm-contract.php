...
try {
    ...
    $mail->Subject = 'Your Signed Francophonie Mobility Contract - Parrot Canada Visa Consultant';
    $mail->isHTML(true);
    $mail->Body = "
    <div style='font-family:Arial,sans-serif;font-size:14px;color:#222;line-height:1.6'>
        <p><strong>Parrot Canada Visa Consultant</strong></p>
        <p>Dear {$clientName},</p>
        ...
        <p style='margin-top:30px'>Kind regards,<br><strong>Parrot Canada Visa Consultant</strong></p>
    </div>";
