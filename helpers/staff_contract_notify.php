...
function pcvc_staff_contract_send_awaiting_email(
    ...
    $fromEmail = xander_env_get('STAFF_CONTRACT_SMTP_FROM_EMAIL') ?: 'infos@visaconsultantcanada.com';
    ...
    $text = "Dear {$staffName},\n\n"
        . "Your {$contractTitle} is ready for review and e-signature in Parrot MIS.\n\n"
