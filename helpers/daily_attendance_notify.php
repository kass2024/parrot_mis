 ...
 * Hello {{1}},
 *
 * Here is your attendance summary for {{2}} at Parrot Canada Visa Consultant:
 *
 * Check-in: {{3}}
 * Check-out: {{4}}
 * Time worked: {{5}}
...
function pcvc_daily_attendance_superadmin_report_html(string $date, array $summaries): string
{
    ...
    return '<div style="font-family:Arial,sans-serif;font-size:14px;">'
        ...
        . '<p style="margin-top:20px;font-size:12px;color:#64748b;">Generated by Parrot MIS Attendance System</p></div>';
}
