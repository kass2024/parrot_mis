 ...
 * Same JWT logic as Parrot-Learning ZoomMeetingSdkService.
 */
...
/**
 * Build in-browser embed room URL (Parrot-Learning frontend) when configured.
 */
function fm_meeting_parrot_learning_frontend_base(): string
{
    xander_load_env_file();
    foreach (['PARROT_LEARNING_FRONTEND_URL', 'ELEARNING_FRONTEND_URL', 'FRONTEND_URL'] as $key) {
