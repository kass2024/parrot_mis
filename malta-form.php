...
$parrotLogo = parrot_brand_logo_href(__DIR__);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; margin-bottom: 20px;">
  ...
  <div style="flex: 1 1 200px;">
    <img src="<?php echo htmlspecialchars($parrotLogo); ?>" alt="Parrot Canada Visa Consultant" style="max-width: 180px; height: auto;" width="180" height="180" decoding="async" />
  </div>
