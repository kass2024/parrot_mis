...
<div class="doc-subtitle">Parrot Canada Visa Consultant Company Ltd.</div>
...
<p><strong>Company:</strong> Parrot Canada Visa Consultant Company Ltd., with registered address at Gasanze Cell, Nduba Sector, Gasabo District, Kigali, Rwanda (the &ldquo;Company&rdquo;).<br>
Company email: admission@visaconsultantcanada.com<br>
Company website: www.visaconsultantcanada.com</p>
...
<p>Formal notices must be in writing. Company notice address: Gasanze Cell, Nduba Sector, Gasabo District, Kigali, Rwanda. Company notice email: infos@visaconsultantcanada.com. Agent notice email: <?= acPdfEsc($agentEmail) ?>.</p>
...
<td style="width:48%;vertical-align:top;padding-right:12pt;">
  <div class="sig-heading">PARROT CANADA VISA CONSULTANT COMPANY LTD.</div>
