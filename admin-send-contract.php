...
try {
    ...
    /* SUBJECT (SAFE ASCII) */
    $mail->Subject = "Your Signed Contract - Parrot Canada Visa Consultant";
    $mail->isHTML(true);
    ...
    <div style='font-family:Arial,Helvetica,sans-serif;
        ...
        <p style='margin-top:30px'>
            Kind regards,<br>
            <strong>Parrot Canada Visa Consultant</strong><br>
            <a href='mailto:admission@visaconsultantcanada.com'>
