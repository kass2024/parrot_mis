...
<head>
<meta charset="UTF-8">
<title>South Korea Event Attendance Service Agreement | Parrot Canada Visa Consultant</title>
      ...
      <div class="signature-grid">
        ...
        <div class="signature-block">
          ...
          <p style="font-weight:700;margin-bottom:18px;font-size:15px;border-top:1px solid #e5e7eb;padding-top:20px;">
            For Parrot Canada Visa Consultant Co. Ltd — Authorized Office Representative
          </p>
