...
$pageTitle = $current_lang === 'en' ? 'Contact Us - Parrot Canada Visa Consultant' : 'Contactez-nous - Parrot Canada Visa Consultant';
...
$contact_translations = [
    'en' => [
        ...
        'hero_description' => 'Questions about study abroad, visas, or scholarships? Contact Parrot Canada Visa Consultant — we assist before and after you obtain your visa.',
        ...
        'sanfrancisco_hours' => 'Email: infos@visaconsultantcanada.com · We reply within 24 hours',
        ...
        'muhanga_hours' => 'infos@visaconsultantcanada.com',
        ...
        'info_email' => 'infos@visaconsultantcanada.com',
        ...
        // Page Metadata
        'page_description' => 'Contact Parrot Canada Visa Consultant - Get in touch with our global offices for international education assistance.',
        'page_title' => 'Contact Us - Parrot Canada Visa Consultant',
    ],
    ...
    'fr' => [
        ...
        'sanfrancisco_phone' => '+250 788 284 544 · +250 789 515 593',
        'sanfrancisco_hours' => 'Courriel : infos@visaconsultantcanada.com · Réponse sous 24 h',
        ...
        // Page Metadata
        'page_description' => 'Contactez Parrot Canada Visa Consultant - Prenez contact avec nos bureaux mondiaux pour une assistance en éducation internationale.',
        'page_title' => 'Contactez-nous - Parrot Canada Visa Consultant',
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($message)) {
        ...
        // Email configuration
        $to = 'infos@visaconsultantcanada.com';
        ...
        <body>
            <div class='container'>
                <div class='header'>
                    ...
                    <p>Parrot Canada Visa Consultant</p>
                </div>
                <div class='content'>
                    <div class='field'>
                ...
                <div class='footer'>
                    <p>This email was sent from the contact form on Parrot Canada Visa Consultant website.</p>
  ...
  <div class="container">
    ...
    <div class="info-grid">
      ...
      <div class="info-card fade-in">
        ...
        <p class="info-content">
          <a href="mailto:infos@visaconsultantcanada.com" class="info-email">
      ...
      <div class="info-card fade-in">
        ...
        <div class="social-links contact-social-grid">
          <a href="https://www.visaconsultantcanada.com/" class="social-link" target="_blank" rel="noopener noreferrer" title="Website"><i class="fas fa-globe"></i></a>
          ...
          <a href="https://www.instagram.com/parrot_canada_visa_consultant?igsh=MTI2NHd4NW9yNHJsNw==" class="social-link" target="_blank" rel="noopener noreferrer" title="Instagram"><i class="fab fa-instagram"></i></a>
          <a href="https://x.com/parrotstudyvisa" class="social-link" target="_blank" rel="noopener noreferrer" title="X"><i class="fab fa-x-twitter"></i></a>
          <a href="https://www.linkedin.com/in/move-abroad-with-parrot-927656353?utm_source=share&amp;campaign=share_via&amp;utm_content=profile&amp;utm_medium=android_app" class="social-link" target="_blank" rel="noopener noreferrer" title="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
          ...
          <a href="https://www.tiktok.com/@moveabroadwithparrot?_t=ZM-8uzEAE5eG85&amp;_r=1" class="social-link" target="_blank" rel="noopener noreferrer" title="TikTok"><i class="fab fa-tiktok"></i></a>
          <a href="https://youtube.com/@moveabroadwithparrot?si=E2txqTu5NmBUWkV" class="social-link" target="_blank" rel="noopener noreferrer" title="YouTube"><i class="fab fa-youtube"></i></a>
